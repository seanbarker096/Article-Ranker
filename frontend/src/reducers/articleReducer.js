...
const articleReducer = (state = initialState, action) => {
  ...
  switch (type) {
    ...
    case `${RESET_REQUEST_STATUS}_articles`:
      return { ...state, status: "idle", errors: {}, currentReqType: null };
    ...
    case DELETE_ARTICLE_SUCCESS:
      ...
      const newarticleIdsArray = state.allIds.filter((id) => id !== articleId);
      return {
        ...state,
    ...
    case EDIT_ARTICLE_SUCCESS:
      article =
        action.payload.articles[Object.keys(action.payload.articles)[0]];
      articleId = article._id;
      return {
        ...state,
      ...
      return {
        ...
        byId: {
          ...
          [articleId]: {
            ...
            comments: [...state.byId[articleId].comments, comment._id],
          },
        },
      };
    case DELETE_COMMENT_SUCCESS:
      ...
      return {
        ...
        byId: {
          ...state.byId,
          [articleId]: { ...state.byId[articleId], comments: newCommentIds },
        },
      };
    default:
      return state;
