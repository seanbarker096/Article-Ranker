...
const VoteButtons = ({
  ...
  useRequestStatus(voteApiReqStatus, null, null, `${parentResourceType}Votes`);
  ...
  return (
    <>
      <div onClick={(e) => handleVoteButtonClick(e)} className="voting buttons">
        <div className="ui right floated vertical icon mini buttons">
          <div className="ui right floated basic label">{voteSum}</div>
          <button
          ...
          <button className="mini ui right floated icon button " id="downVote">
